...
class ImageClassifier:
    ...
    def train_knn(self, n_neighbors=3, weights='uniform', algorithm='auto', leaf_size=30, p=2):
...
if __name__ == "__main__":
    folder_current = r'D:\SEMESTER 4\PEMBELAJARAN MESIN\Deteksi_NovelOri'
    DATASET_DIR = os.path.join(folder_current,  'Dataset', 'Novel')
    ...
    test_image = '2.jpg'
    test_image_path = os.path.join(folder_current,'Dataset', test_image)  # Masukkan path gambar uji di sini
