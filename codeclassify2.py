...
if __name__ == "__main__":
    folder_current = 'D:\Online\OneDrive - Dian Nuswantoro University\Work Lecturer\CV'
    DATASET_DIR = folder_current + '\code_basedImage\Dataset\car'
    MODEL_DIR = folder_current + '\code_basedImage\Model'
    FEATURE_DIR = folder_current + '\code_basedImage\Fitur'
